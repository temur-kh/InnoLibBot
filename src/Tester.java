...
public class Tester {
    ...
    public static void TC8() {
        ...
        Calendar fromDate1 = new GregorianCalendar(2018, 1, 12);
        Calendar toDate1 = new GregorianCalendar(2018, 1, 12);
        ...
        Calendar fromDate2 = new GregorianCalendar(2018, 1, 5);
        Calendar toDate2 = new GregorianCalendar(2018, 1, 5);
        ...
        Calendar fromDate3 = new GregorianCalendar(2018, 1, 8);
        Calendar toDate3 = new GregorianCalendar(2018, 1, 8);
        ...
        Calendar fromDate4 = new GregorianCalendar(2018, 1, 20);
        Calendar toDate4 = new GregorianCalendar(2018, 1, 20);
        ...
        System.out.println("p1"
                + ", overdue:" + (CalendarObjectCreator.convertToCalendar(new Time(today.getTimeInMillis()-toDate2.getTimeInMillis()))));
